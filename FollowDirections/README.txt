...
Problem:
In this problem, you program will simulate a robot moving about a grid. 
You are given a set of directions. Your job is to compute your final position.
...
6) Express your answer as comma-separated integer pair where the first number is the distance travelled 
along East-West, and the second is the distance travelled along North-South. 
